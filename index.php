...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll">
            ...
            <li class="nav-item">
              <a href="index.php#Aboutme" class="nav-link">Sobre mi</a>
            </li>
            <li class="nav-item">
              <a href="index.php#Skills" class="nav-link">Skills</a>
            </li>
            <li class="nav-item">
              <a href="index.php#Proyectos" class="nav-link">Proyectos Principales</a>
            </li>
            <li class="nav-item">
  ...
  <section id="Home">
    ...
    <div class="home-img">
      <img src="imagenes/perfil/perfil4.png" alt="perfil">
    </div>
    <div class="main-content-home">
      ...
      <div class="home-iconos-redes">
        <ul class="redes">
          <li>
            <a href="https://www.linkedin.com/in/martin-contreras-/" target="_blank" title="Te lleva a mi LinkedIn"><i class="bi bi-linkedin"></i></a>
          </li>
          <li>
            <a href="https://github.com/jahcr1" target="_blank" title="Te lleva a mi Github"><i class="bi bi-github"></i></a>
          </li>
          <li>
            <a href="https://wa.me/5493516451510?text=Hola%20quiero%20más%20información" target="_blank" title="Te lleva a mi WhatsApp"><i class="bi bi-whatsapp"></i></a>
          </li>
        </ul>
      </div>
      <div class="home-content-info">
        <p class="texto-random text-center">Descargá el CV ó contactame más abajo</p>
        <div class="button-container">
          <a role="button" class="btn btn-estilo" href="componentes/cv.pdf" download="cv.pdf" rel="noopener noreferrer" target="_blank" title="Descargar Curriculum Vitae">CV <i class="bi bi-download"></i></a>
          <button type="button" class="btn btn-estilo" onclick="window.location.href='index.php#Contact';">Contáctame</button>
        </div>
      </div>
    </div>
  ...
  <section id="Skills">
    ...
    <h1 class="titulo" style="justify-content: start;">Skills y tecnologías</h1>

    <div class="container">
      <p class="sub-titles text-center">Lenguajes de programación</p>
      <div class="main-content-section">
        ...
        <!-- Icono SVG de CSS3 -->
        <svg width="60" height="60" viewBox="0 0 128 128">
          <path fill="white" d="M89.234 5.856H81.85l7.679 8.333v3.967H73.713v-4.645h7.678l-7.678-8.333V1.207h15.521v4.649zm-18.657 0h-7.384l7.679 8.333v3.967H55.055v-4.645h7.679l-7.679-8.333V1.207h15.522v4.649zm-18.474.19h-7.968v7.271h7.968v4.839H38.471V1.207h13.632v4.839z"></path>
          ...
          <path fill="#EBEBEB" d="M64.067 95.146l-.049.014-12.404-3.35-.794-8.883H39.641l1.561 17.488 22.814 6.333.052-.015V95.146z"></path>
          <path fill="#fff" d="M77.792 76.886L76.45 91.802l-12.422 3.353v11.588l22.833-6.328.168-1.882 1.938-21.647H77.792z"></path>
          <path fill="#EBEBEB" d="M64.039 43.677v11.137H37.136l-.224-2.503-.507-5.646-.267-2.988h27.901zM64 66.221v11.138H51.753l-.223-2.503-.508-5.647-.267-2.988H64z"></path>
        </svg>


        <!-- Icono SVG de Javascript -->
        <svg width="60" height="60" viewBox="0 0 128 128">
    ...
    <div class="container">
      <p class="sub-titles text-center">Tecnologías, extensiones y herramientas de desarrollo</p>
      <div class="main-content-section">

        <!-- Icono SVG de VISUAL STUDIO CODE-->
        <img src="./imagenes/icons/vscode.svg" alt="vscode1" style="width: 60px; height:60px;">
        ...
        <!-- Icono SVG de GITHUB-->
        <svg width="70" height="70" viewBox="0 0 128 128">
          <g fill="#181616" stroke="#FFFFFF" stroke-width="1">
        ...
        <svg width="80" height="80" viewBox="0 0 128 128">
          ...
          <defs>
            ...
            <linearGradient id="c" x1="3.002" x2="15.421" y1="86.834" y2="60.201" gradientUnits="userSpaceOnUse">
              ...
              <stop offset=".095" stop-color="#662E8C"></stop>
  ...
  <section id="Proyectos">
    ...
    <div class="projects">
      ...
      <div class="project-card" data-aos="fade-up">
        ...
        <div class="project-content">
          ...
          <div class="project-links">
            <a href="https://github.com/jahcr1/kudaySTORE" target="_blank">GitHub</a>
            <a href="https://kudayartesanias.com.ar" target="_blank">Ver Sitio</a>
          </div>
        </div>
      </div>
      ...
      <div class="project-card" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="project-content">
          ...
          <p class="project-description">
            En este proyecto se priorizó el uso de funciones de PHP, PDO y scripts para una validación completa y segura de un <span>LOGIN</span>, tanto para el Front como para el Back. Así aprendí a mejorar las validaciones de datos en los formularios al momento de crear cualquier cuenta en una aplicacion web.<br>Otra cosa que utilicé fueron las funciones de <span>Encriptación de Passwords</span> en la base de datos y regeneracion de las mismas, para tener más seguridad y generar confianza con las Bases de Datos de clientes más estrictos.
          </p>
          ...
          <div class="project-links">
            <a href="https://github.com/jahcr1/secure-login" target="_blank">GitHub</a>
      ...
      <div class="project-card" data-aos="fade-up">
        <div class="project-image">
          <img src="imagenes/proyectos/p31.png" alt="Funciones PHP">
        </div>
        <div class="project-content">
          <h3 class="project-title">Funciones PHP</h3>
  ...
  <!--    SCRIPT CON JS PARA ESCONDER LA BARRA AL HACER SCROLL  -->
  <script>
    let lastScrollTop = 0;
  ...
  <!--    SCRIPT CON JS PARA HACER UN TEXTO DINÁMICO  -->
  <script>
    ...
    let index = 0;
    const textElement = document.querySelector(".text-din"); // Contenedor del texto
    const cursorElement = document.querySelector(".cursor"); // Cursor

    function typeText() {
      const currentText = texts[index]; // texto actual
      textElement.textContent = ""; // limpiamos la cadena de texto

      let charIndex = 0; // indice del primer caracter
      const typingInterval = setInterval(() => {

        if (charIndex < currentText.length) {

          textElement.textContent += currentText.charAt(charIndex); // sumamos una letra
          charIndex++; //incrementamos el indice

        } else {
          clearInterval(typingInterval); // Finaliza el tipado

          // Espera 2 segs y cambia al siguiente texto
          setTimeout(() => {
            index = (index + 1) % texts.length; // Cicla entre los textos
            typeText(); // Repite la animación
          }, 2000); // Espera 2 segundos antes de cambiar
        }
      }, 100); // Velocidad de tipado
    }
  ...
  <script>
    AOS.init({
      duration: 900, // velocidad animación
